...
/**
 * Agora meça o tempo utilizando somente uma thread.
 */
public class ComUmaThread {
    ...
    public static void recolorirUmaThread(BufferedImage imgOrigem, BufferedImage imgResultado) {
        recolorirImagem(imgOrigem, imgResultado, 0, 0,
                imgOrigem.getWidth(), imgResultado.getHeight());
    }
